...
export default function CheckoutPage() {
  ...
  if (authLoading) return <main className="checkout-page"><Link className="brand" href="/">MUNDO <span>CONTACTO</span></Link><p>Cargando tu cuenta...</p></main>;
  if (!items.length) return <main className="checkout-page"><Link className="brand" href="/">MUNDO <span>CONTACTO</span></Link><section className="checkout-empty"><h1>Tu carrito está vacío</h1><p>Agrega productos y vuelve para completar tu pedido.</p><Link href="/productos" className="primary-action">Ver productos</Link></section></main>;
